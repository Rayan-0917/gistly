...
const Sidebar = ({history, onSelect, onDelete, onClearAll}) => {
  return (
    <aside className='w-full md:w-80 bg-slate-700 border-r border-slate-200 h-auto md:h-screen overflow-y-auto p-6 flex flex-col'>
